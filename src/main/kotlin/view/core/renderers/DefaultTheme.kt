 ...
 *
 * Note that the Theme won't modify view properties that already have a value, it will just set a value if the view property
 * is not initialized.
 *
...
open class DefaultTheme: Theme() {
    ...
    private val viewPreprocessor = { view: Any ->
        if (view !is View) {
            ...
            if (view.marginStart == null) view.marginStart = horizontalMargin
            if (view.marginEnd == null) view.marginEnd = horizontalMargin
            if (view.marginTop == null) view.marginTop = verticalMargin
            if (view.marginBottom == null) view.marginBottom = verticalMargin
        }
    }
